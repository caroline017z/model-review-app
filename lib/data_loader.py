...
def load_pricing_model(file):
    ...
    for col in range(6, 88):
        ...
        # ---- Wrapped EPC build: sum subcomponents (rows 103-108 in typical models) ----
        # The bible's EPC benchmark compares against the wrapped total MINUS
        # PV Contingency. PV Contingency is tracked separately as a line item.
        epc_components = []
        wrapped_total = 0.0
        ...
        # Plausibility check: each component should be in $/W range (0-10).
