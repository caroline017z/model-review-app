...
export function TopBar() {
  ...
  return (
    <header className="h-[46px] bg-navy text-white flex items-center px-[18px] gap-5 shadow-[0_1px_4px_rgba(5,13,37,0.25)] relative z-10">
      ...
      <div className="ml-auto flex gap-4 text-[10.5px] text-white/60 tracking-[0.02em]">
        {portfolio && (
          <>
            ...
            <span>Loaded: <b className="text-white/90 font-semibold">{portfolio.loadedDate}</b></span>
